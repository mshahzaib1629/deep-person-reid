...
# - In this test, Representative Memory is being used on every incremental step without any finetuning. We are training the model from scrach on every incremental step.
